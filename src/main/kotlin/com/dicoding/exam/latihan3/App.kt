...
fun <T> checkType(args: T): String {
    val resultTemplate = "Yes! it's "
    return when(args) {
        is Int -> resultTemplate+"Integer"
        is String -> resultTemplate+"String"
        is Boolean -> resultTemplate+"Boolean"
        is Double -> resultTemplate+"Double"
        is List<*> -> resultTemplate+"List"
        is Map<*,*> -> resultTemplate+"Map"
        else -> "Data type not listed"
    }
}
